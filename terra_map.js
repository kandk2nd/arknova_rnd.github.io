...
const DivList4 = () => {
    ...
    const items = [
        7, 0, 6, 5, 4, 2, 1, 0, 6, 5, 4, 3, 0,
        1, 0, 0, 7, 6, 7, 3, 0, 7, 1, 6, 0, 5,
        2, 6, 5, 0, 1, 4, 5, 0, 0, 2, 0, 0, 2,
        3, 1, 2, 0, 3, 2, 0, 5, 0, 0, 4, 1, 4,
        4, 7, 4, 3, 0, 0, 0, 7, 1, 6, 2, 3, 7,
        5, 0, 0, 0, 6, 1, 0, 3, 4, 0, 5, 6, 2,
        6, 0, 4, 5, 0, 7, 4, 0, 0, 0, 0, 0, 0,
        0, 3, 6, 0, 2, 5, 3, 2, 5, 6, 7, 5, 0,
        7, 1, 2, 0, 3, 1, 4, 6, 7, 1, 2, 3, 4,
    ];  /*ここにクラス名を*/
    const divs = [];
    const MAX_ROW = 13;
